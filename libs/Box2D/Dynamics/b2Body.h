...
public:
    ...
    //flag that indicates weather the current platform is ipad
    bool bisIpad;
	...
	void ApplyForce(b2Vec2& force, const b2Vec2& point);
...
inline void b2Body::ApplyForce(b2Vec2& force, const b2Vec2& point)
{
