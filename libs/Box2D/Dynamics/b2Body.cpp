...
*///this is an altered version. I added the body id functions, variables, and static int
...
//static int curBodyID;

//void b2Body::setCurBodyID(int newID){
 //   curBodyID = newID;
//}
...
b2Body::b2Body(const b2BodyDef* bd, b2World* world)
{
    ...
    bisIpad = Singleton::sharedInstance()->isIpad;
}
